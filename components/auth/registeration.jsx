...
const navigate = useNavigate()
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-black/90 to-black/70">
      <div className="w-full max-w-md bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 md:p-12">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg bg-white/10 text-white placeholder-white/50 border border-white/30 focus:outline-none focus:ring-2 focus:ring-green-500"
              required
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              required
              className="w-full px-4 py-3 rounded-lg bg-white/10 text-white border border-white/30 focus:outline-none focus:ring-2 focus:ring-green-500"
            >
